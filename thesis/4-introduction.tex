...
In this study we consider a set of techniques that...\fxnote{add description of
the evaluation chapter}

With the understanding of the limitations of current approaches, we propose
