...
This can be observed in the first 50 seconds of the experiment depicted in
Figure ~\ref{fig:tpcc_repartitioning}: low throughput (i.e., a few transactions
executed per second), high latency (i.e., up to several seconds), and a high
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.8\columnwidth]{./figures/experiments/dynastar/metis_size_time}
