...
%\begin{figure}[ht]
%  \includegraphics[width=0.95\columnwidth]{figures/experiments/dynastar/chirper-celeb-dynastar}
%  \caption{Dynamic partitioning with DynaStar.}
%  \label{fig:4p1p_varying_partition_size}
%\end{figure}
%
% \begin{figure}[ht]
%  \includegraphics[width=0.99\columnwidth]{figures/experiments/dynastar/chirper-compare-full}
...
%       \centering
%       \includegraphics[width=\columnwidth]{./figures/experiments/dynastar/chirper-compare-timeline-tp.pdf}
%     \end{subfigure}
%     % \hfill %%
%     \begin{subfigure}{.45\columnwidth}
%       \centering
%       \includegraphics[width=\columnwidth]{./figures/experiments/dynastar/chirper-compare-mix-tp.pdf}
%     \end{subfigure}
%   \end{subfigure}
%   \vfill %%
%   \begin{subfigure}{0.95\columnwidth}
%     \begin{subfigure}{.45\columnwidth}
%       \centering
%       \includegraphics[width=\columnwidth]{./figures/experiments/dynastar/chirper-compare-timeline-lat.pdf}
%     \end{subfigure}
%     \hfill %%
%     \begin{subfigure}{.45\columnwidth}
%       \centering
%       \includegraphics[width=\columnwidth]{./figures/experiments/dynastar/chirper-compare-mix-lat.pdf}
%     \end{subfigure}
%   \end{subfigure}
...
This happens because objects in \dssmr{} will only converge if there is a perfect way to
...
% \begin{figure}[ht]
% 	\includegraphics[width=\columnwidth]{figures/experiments/dynastar/chirper-oracle-load.pdf}
