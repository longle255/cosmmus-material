%!TEX root =  main.tex
\chapter[Scaling partitioned replicated system]{Scaling partitioned replicated systems}
...
consistent state, given a consistency criteria. Over more than three
decades, replication has become an area of interest and has been studied in
many domains, such as database systems, file systems, and later in
...
requests to the different replicated machines. Each replica can then process requests in
parallel and improve the throughput of the system. 
...
\subsubsection{Single partition transaction} 
