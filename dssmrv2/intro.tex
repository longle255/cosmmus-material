...
%% commands within and across partitions.  Commands that access variables
...
%% SMR.  Commands that access variables located in multiple partitions
...
%To define locality, assume that the workload is represented by a graph in which vertices are variables, the service state, and edges interconnect variables accessed by a command. 
