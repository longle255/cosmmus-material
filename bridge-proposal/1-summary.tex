...
service. \lle{The cost of each query depends on the time and resources that the
system has spent for that query}. With the information provided by the oracle, the
