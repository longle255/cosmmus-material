...
command. \fp{not clear why it should get worse} In order to improve the scalability of SMR, several systems
...
partitioning \fp{this needs improvements}.  Thus, an ideal partitioning scheme is one that would
...
partitioning. \emph{Static} schemes choose an optimal \fp{not necessarily optimal} partitioning
...
al.~\cite{hoang2016}. \red{what is the workload?} \fp{a social network}
