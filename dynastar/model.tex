...
In this section, we present the system model, recall the abstractions of reliable and atomic multicast, and define linearizability, our correctness criterion.
