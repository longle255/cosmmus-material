...
\subsection{Results}
As we see in the Figure~\ref{fig:varying_edge_cut}, all the techniques perform similar on tests with strong locality. As
the number of edge-cuts get higher, \dssmr performance decreases significantly both in terms of throughput and latency.
\dynastar
