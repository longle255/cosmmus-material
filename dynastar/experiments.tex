...
Since we focus our tests in the post command, we are interested in see what happens when we increase the number of
partitions, with a higher number of partitions we should be able to achieve a high scalability but the amount of edge-cuts
