...
\textbf{The oracle proxy.} One of the purposes of the oracle proxy is to tell client proxies where each variable is located, so that commands can be multicast to the right partitions.
