...
In Section~\ref{sec:evaluation:highloc}, we show the results with strong-locality workloads.
...
We can see in Figure~\ref{fig:highloc} the results achieved with \appname{}, running with a strong-locality workload.
