...
defined in Section~\ref{sec:rmcast} and Section~\ref{sec:amcast}.
...
\begin{itemize}
    ...
    \item[--] No two processes $p$ and $q$ in both $\gamma$ and $\gamma'$ \amdel\ $m$ and $m'$ in different orders \emph{(atomic order)}.
