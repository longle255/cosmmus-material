...
\begin{itemize}
    ...
    \item[--] For any two messages $m$ and $m'$ and any two processes $p$ and $q$ such that ${p, q} \subseteq m.dst \cap m'.dst$, if $p$ delivers $m$ and $q$ delivers $m'$, then either $p$ delivers $m'$ before $m$ or $q$ delivers $m$ before $m'$. \fxnote[draft]{Add uniform order property}
