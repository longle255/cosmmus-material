...
%\begin{figure}[ht]
%  \includegraphics[width=0.95\columnwidth]{figures/eurosys/chirper-celeb-dynastar}
%  \caption{Dynamic partitioning with DynaStar.}
%  \label{fig:4p1p_varying_partition_size}
%\end{figure}
%
%\begin{figure}[ht]
%  \includegraphics[width=0.95\columnwidth]{figures/eurosys/chirper-celeb-ssmr}
...
\begin{figure*}[h!]
  ...
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[width=\textwidth]{./figures/eurosys/chirper-latency-cdf-2p.pdf}
%    \caption{}
  \end{subfigure}
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[width=\textwidth]{./figures/eurosys/chirper-latency-cdf-4p.pdf}
%    \caption{}
  \end{subfigure}
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[width=\textwidth]{./figures/eurosys/chirper-latency-cdf-8p.pdf}
%    \caption{}
  \end{subfigure}
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics[width=\textwidth]{./figures/eurosys/chirper-latency-cdf-16p.pdf}
%    \caption{}
  \end{subfigure}
...
Figure~\ref{fig:socialscalability} shows the peak throughput and latency for $\approx$75\% of peak throughput
...
Figure~\ref{fig:socialcdf} shows the cumulative distribution functions (CDFs) of latency for the mix workload of \dynastar and \ssmr on different partitioning configurations. The latency difference between the two techniques suggest that \ssmr brought a lower latency than \dynastar for 80\% of the load. This is expected, as for multi-partition commands, partitions in \dynastar has to send another message to return the objects to their original location. 
...
At the begin of the experiment, \dynastar performance was not as good as \ssmr (e.g. lower throughput, higher number of
