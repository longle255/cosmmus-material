...
\begin{itemize}
\item \emph{What is the impact of repartitioning on a workload?}
...
We have simulated clients, each client issues a sequence of commands.  
For each command, the client selects a random node as the poster with Zipfian access pattern, with Zipf 
parameter $\rho$ = 0.99.
