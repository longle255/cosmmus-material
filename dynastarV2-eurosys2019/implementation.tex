...
BaseCast is a genuine atomic multicast in that only the sender and destination replicas of a message communicate to propagate and order a multicast message. 
