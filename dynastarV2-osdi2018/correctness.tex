...
Since the move only finishes when variables in $vars$ are in $\ppm_i$ and then $C_i$ can be executed\lle{move only finishes when $P_j$ gets back its variable}, it must be that
