...
plot 'social-network-ideal-partition.dat' using 2:xtic(1) fs pattern 1 lc rgb '#888888' title 'DynaStar', \
        '' using 3:xtic(1) fs pattern 2 lc rgb '#888888' title "S-SMR~ {.1*}"