...
% As a point of comparison, we perform the same experiments with both
% \ssmr{} and \dssmr. 
...
Figure~\ref{fig:4p1p_varying_partition_size} shows that \dynastar throughput scales up with certain number of partitions. From 8 to 9 partitions, the performance decreases.
