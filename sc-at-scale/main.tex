...
For example, in workloads that do not experience locality, the overhead in throughput introduced by execution atomicity in commands that span two partitions is around 7\% in executions with 16 partitions;
in workloads with data locality, this overhead is around 12\%.
%Since locality results in high throughput, the effects of execution atomicity on performance are more important in such settings.
%The more partitions are involved in a multi-partition command, the less the overhead introduced by execution atomicity is, varying from 53\% of performance overhead with two partitions to 12\% of overhead with 16 partitions in workloads with locality.
...
%Table~\ref{tbl:default} shows the percentage of overhead in throughput due to signals in workloads that experience locality and in balanced workloads (i.e., without locality).
%The more partitions are involved in a multi-partition command, the less the overhead introduced by execution atomicity is, both in workloads that exhibit locality and workloads that do not.
%
%\begin{table}[htp]
%\centering
%\small
%\begin{tabular}{|l|c|c|c|c|} \hline
%Dataset...				& Partitions	& Timeline		& Post		& Follow/Unfollow \\ \hline
%~~~~...without locality	& 2			&			& 			&	49\%              \\ \cline{2-2}\cline{5-5}
%              				& 4			& 			& 			&	31\%              \\ \cline{2-2}\cline{5-5}
%              				& 8			&\raisebox{1.5ex}[0cm][0cm]{$\leq$7\%}&\raisebox{1.5ex}[0cm][0cm]{$\leq$2\%}&	24\% \\ \cline{2-2}\cline{5-5}
%              				& 16			&			& 			&	7\%               \\ \hline
%~~~~...with locality		& 2			&			& 			&	53\%              \\ \cline{2-2}\cline{5-5}
%              				& 4			& 			& 			&	36\%              \\ \cline{2-2}\cline{5-5}
%              				& 8			&\raisebox{1.5ex}[0cm][0cm]{$\leq$7\%}&\raisebox{1.5ex}[0cm][0cm]{$\leq$1\%}&	23\% \\ \cline{2-2}\cline{5-5}
%              				& 16			&			& 			&	12\%              \\ \hline
%\end{tabular}
%\begin{tabular}{|l|c|c|c|c|} \hline
%Dataset...			& Partitions	& Timeline		& Post		& Follow/Unfollow \\ \hline
%~~~~...with locality		& 2			&	0\%	        & 0\%		&	53\%              \\ \cline{2-5}
%              			& 4			&	0\%	        & 0\%		&	36\%              \\ \cline{2-5}
%              			& 8			&	7\%	        & -5\%	    	&	23\%              \\ \cline{2-5}
%              			& 16			&	1\%	        & 1\%		&	12\%              \\ \hline
%~~~~...without locality	& 2			&	1\%	        & 2\%		&	49\%              \\ \cline{2-5}
%              			& 4			&	0\%	        & 1\%		&	31\%              \\ \cline{2-5}
%              			& 8			&	7\%	        & 1\%		&	24\%              \\ \cline{2-5}
%              			& 16			&	2\%	        & -117\%		&	7\%               \\ \hline
%\end{tabular}
%\caption{Overhead in throughput due to signals in datasets with and without locality.}
%\label{tbl:default}
%\end{table}%
