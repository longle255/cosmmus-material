...
set style line 1 lt 1 lw 2 lc 0 pt 1 ps 1.0 
set style line 2 lt 2 lw 2 lc 1 pt 2 ps 1.0 
set style line 3 lt 3 lw 2 lc 3 pt 3 ps 1.0 
set style line 4 lt 4 lw 2 lc 4 pt 4 ps 1.0
...
plot './data-aggregated/ramcast/xl170/broadcast-opt/latency-cdf-4096b.dat' using 1:2 with linespoints ls 1 title "4KB ", \
     './data-aggregated/ramcast/xl170/broadcast-opt/latency-cdf-8192b.dat' using 1:2 with linespoints ls 2 title "8KB ", \
     './data-aggregated/ramcast/xl170/broadcast-opt/latency-cdf-16384b.dat' using 1:2 with linespoints ls 3 title "16KB", \
     './data-aggregated/ramcast/xl170/broadcast-opt/latency-cdf-32768b.dat' using 1:2 with linespoints ls 4 title "32KB"
