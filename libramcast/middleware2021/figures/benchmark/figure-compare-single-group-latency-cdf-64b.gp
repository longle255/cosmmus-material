...
plot 'data-aggregated/ramcast/broadcast-opt/cdf-1client-64B-vs-kpaxos.dat' using 1:2 with linespoints ls 1 title "RamCast",\
     'data-aggregated/kpaxos/cdf-1client-64B.dat' using 1:2 with linespoints ls 2 title "Kernel Paxos",\
     'data-aggregated/mu/cdf-1c-64B.dat' using ($1/1000):2 with linespoints ls 3 title "Mu",\
     'data-aggregated/apus/cdf-1client-64B.dat' using 1:2 with linespoints ls 4 title "APUS"
